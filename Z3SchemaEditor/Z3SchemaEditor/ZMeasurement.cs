...
namespace Z3.Model {
    public class ZMeasurement : Watchable, Hotkeyable {
        ...
        public void Save()
        {
            ...
            {
                cmd.CommandText = "update Z3MeasurementTypes set name=?,measured=?,counted=?,autocount=?,increment=?,displayed=?,counttype=?,autotype=?,hotkey=?,defaultmode=? where internalid=?";
                cmd.Parameters.AddWithValue("@name", this.Name);
                cmd.Parameters.AddWithValue("@meas", this.Measured);
                cmd.Parameters.AddWithValue("@ctd", this.Counted);
                cmd.Parameters.AddWithValue("@act", this.AutoCount);
                cmd.Parameters.AddWithValue("@inc", this.Increment);
                cmd.Parameters.AddWithValue("@dis", this.Displayed);
                cmd.Parameters.AddWithValue("@cti", this.CountTypeID);
                cmd.Parameters.AddWithValue("@ati", this.AutoTypeID);
                cmd.Parameters.AddWithValue("@hky", this.Hotkey);
                cmd.Parameters.AddWithValue("@def", this.Default);
                cmd.Parameters.AddWithValue("@iid", this.ID);
                cmd.ExecuteNonQuery();
            }
        }
    }
